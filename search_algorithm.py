...
def array_pmf(gas_names, number_mofs, mof_names, calculate_pmf_results):
    ...
    number_mofs -- current number of mofs in array
    mof_names -- list of all mofs
    calculate_pmf_results -- list of dictionaries including mof, mixture, probability
    """
    num_mofs = number_mofs
    ...
    mof_array_list = list(combinations(mof_names, num_mofs))
